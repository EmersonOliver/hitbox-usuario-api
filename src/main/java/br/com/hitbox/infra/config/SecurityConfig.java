    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/permissions/**").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/permissions/**").authenticated()
                        .requestMatchers(HttpMethod.DELETE, "/permissions/**").authenticated()
